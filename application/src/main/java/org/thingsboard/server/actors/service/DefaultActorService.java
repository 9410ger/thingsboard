...
public class DefaultActorService implements ActorService {
    ...
    //Mensajes que llegan de afuera, sensores, dispositivos, etc (MQTT, HTPP, COAP)
    @Override
    ...
    //Mensajes que llegan por ejecución de un plugin por websockets
    @Override
    ...
    //Mensajes que llegan por ejecución de un plugin por un rest api
    @Override
